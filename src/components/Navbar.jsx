...
const Navbar = () => {
  ...
  return (
    <nav
      className={`${styles.paddingX} py-5 w-full flex items-center fixed top-0 z-20 bg-primary border-b border-[#9da2c0]`}
    >
      <div className="w-full flex justify-between items-center max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-[#807070] text-[18px] font-bold cursor-pointer flex">
            {personalInfo.name} &nbsp;
